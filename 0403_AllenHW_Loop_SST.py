...
"""
pv_metadata_nwbs = pd.read_csv("0309_sst_metadata_nwbs.csv", index_col=0)
...
df_allPV.to_csv('0403_df_allSST_start.csv', index=True)
...
df_allPV=pd.read_csv("0403_df_allSST_0_471_473_1000_1003_1007_1009_1043_1045_1183_1185_1198_1200_1292_1294_1334_1336_1429_1431_1462_1464_1573_1575_1602_1604_1608_1610_1657.csv")
...
for i_cell in range(1659, n_cells): # an error on SST cell 472, t_start = None # same error on cell 1001, 1002, 1044, 1184, 1199, 1430, 1463, 1574, 1603, 1658; cell 1008, 1293, 1335 list index out of range (all drop_flage False)
    # cell 1335: long list of "The firing threshold is not found!! "
    ...
    TempPath='0403_SST_HW/Cell'+str(i_cell)+'/'
...
df_allPV.to_csv('0403_df_allSST_0_471_473_1000_1003_1007_1009_1043_1045_1183_1185_1198_1200_1292_1294_1334_1336_1429_1431_1462_1464_1573_1575_1602_1604_1608_1610_1657_1659_end.csv', index=True)
