...
#for i_cell in [5,6]:
for i_cell in range(487,n_cells): # save data from 0 to 485 # now save data form 487 to the end
    print(i_cell)
    cell_flag=True
    
    TempPath='PV_all_layer/Cell'+str(i_cell)+'/'
...
Output_df.to_csv('Output_df_pv_0314_487_end.csv', index=False)
