...
plt.figure(figsize=(12, 12))  # Checking for adaptation index.         
plt.subplot(311)
...
plt.plot(sweep.t-t_start,sweep0.v)
...
plt.plot(t_spike_max,FI_vec_max)
plt.plot(t_spike_rheo,FI_vec_rheo)
ax.set_xlim([-0.1,1.1])
